        ...
        class employees {
            constructor(args) {
                ...
                self.goToEditTeam = (event, data) => {
                    ...
                    localStorage.setItem("teamId", clickedTeamId); // Store the team ID in localStorage
                ...
                self.formSubmit4 = () => {
                    ...
                    if (formValid) {
                        ...
                        $.ajax({
                            ...
                            type: 'POST',
                            data: JSON.stringify({
                                team_id: localStorage.getItem("teamId"), // Retrieve the team ID from session storage
