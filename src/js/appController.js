     ...
     function ControllerViewModel() {
      ...
      if(sessionStorage.getItem('userRole')=='employee'){
        ...
        var navData = [
          ...
          { path: 'purchaseClosure', detail : {label: 'Purchase Closure',iconClass: 'oj-navigationlist-item-icon fa fa-home'} },
          { path: 'poSettings', detail : {label: 'Purchase Order Settings',iconClass: 'oj-navigationlist-item-icon fa fa-list-check'} },
          { path: 'finance', detail : {label: 'finance',iconClass: 'oj-navigationlist-item-icon fa fa-home'} },
          { path: 'expenseReport', detail : {label: 'Expense Report',iconClass: 'oj-navigationlist-item-icon fa fa-home'} },
          { path: 'purchaseReport', detail : {label: 'Purchase Report',iconClass: 'oj-navigationlist-item-icon fa fa-home'} },
