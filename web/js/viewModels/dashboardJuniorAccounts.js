define(['ojs/ojcore',"knockout", 'ojs/ojcontext', "jquery","appController","ojs/ojconverterutils-i18n", 
    ...
    "ojs/ojchart","ojs/ojactioncard","ojs/ojformlayout", "ojs/ojdialog","ojs/ojvalidationgroup","ojs/ojprogress-circle"], 
function (oj,ko,Context,$, app, ojconverterutils_i18n_1, ArrayDataProvider) {
    
    class dasboardJuniorAccountsViewModel {
        constructor(args) {
            var self = this;
            ...
            self.getTaskCount=()=>{
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        self.pendingTasks(data[0][2])
                        self.completedTasks(data[0][3])
                    }
                });
            }
    ...
    return  dasboardJuniorAccountsViewModel;
});