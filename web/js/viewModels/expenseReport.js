        ...
        class expense {
            constructor(args) {
                ...
                function getAllExpenseReport(){
                    ...
                    document.getElementById('loaderView').style.display='block';
                    $.ajax({
                        url: BaseURL+"/HRModuleGetAllExpenseReportForFinance",
                        type: 'GET',
                        timeout: sessionStorage.getItem("timeInetrval"),
                        context: self,
                        error: function (xhr, textStatus, errorThrown) {
                        ...
                        success: function (data) {
                            ...
                            console.log(data)
                                var csvContent = '';
                                var headers = ['Expense No', 'Name', 'Designation', 'Department', 'Expense Name', 'Amount', 'Date of Request', 'Payment Status'];
                ...
                self.showData = ()=>{
                    ...
                    $.ajax({
                        url: BaseURL+"/getSelectedExpenseReportForFinance",
                        type: 'POST',
                        data: JSON.stringify({
                            fromDate: fromDate,
                            toDate: toDate,
